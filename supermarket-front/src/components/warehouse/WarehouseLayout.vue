<template>
  <div class="dashboard-layout">
    ...
    <div class="main-content">
      <aside class="sidebar">
        <ul>
          <li @click="$router.push('/warehouse/inventory')">库存管理</li>
          <li @click="$router.push('/warehouse/stockin')">商品入库</li>
          <li @click="$router.push('/warehouse/lowstock')">低库存预警</li>
          <li @click="$router.push('/warehouse/loss')">商品损耗</li>
        </ul>
      </aside>
